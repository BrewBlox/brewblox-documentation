...
Scenario: View process data
    Given there is an active process
    And the active process contains UI blocks with a hardware association
    When I click the View Process Data button
    Then I should see all data generated by the process UI blocks

Scenario: View UI block data
    Given there is an active UI block
    And the UI block has a hardware association
    When I click the View UI block Data button
